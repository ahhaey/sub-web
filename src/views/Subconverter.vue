...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "subconverter.vercel.app (hello world）": "https://subconverter.vercel.app/sub?",
        ...
        backendOptions: [
          ...
          { value: "https://subconverter.vercel.app/sub?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://subconverter.vercel.app/sub?";
